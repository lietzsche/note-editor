...
export const styles: Record<string, CSSProperties> = {
  ...
  searchContextPanel: {
    ...
    padding: "12px 14px",
    borderRadius: "var(--radius-md)",
    border: "1px solid color-mix(in srgb, var(--color-warning, #f4c542) 26%, var(--color-border-subtle))",
    background:
      "linear-gradient(135deg, color-mix(in srgb, var(--color-warning, #f4c542) 10%, transparent), transparent 62%), var(--app-control-bg)",
    display: "grid",
    gap: "10px",
  },
  searchContextHeader: {
  ...
  searchContextBadge: {
    ...
    padding: "0 10px",
    borderRadius: "999px",
    border: "1px solid color-mix(in srgb, var(--color-warning, #f4c542) 22%, var(--color-border-subtle))",
    background: "var(--app-panel-bg-strong)",
    color: "var(--color-text-secondary)",
    fontSize: "11px",
    fontWeight: 600,
  ...
  searchContextNavigator: {
    display: "flex",
    alignItems: "center",
    gap: "6px",
  },
  searchContextNavButton: {
    display: "inline-flex",
    alignItems: "center",
    justifyContent: "center",
    minWidth: "28px",
  ...
  searchContextNavButtonDisabled: {
    opacity: 0.45,
    cursor: "default",
  },
  ...
  searchContextDismissIconButton: {
    display: "inline-flex",
    alignItems: "center",
    justifyContent: "center",
    minWidth: "32px",
