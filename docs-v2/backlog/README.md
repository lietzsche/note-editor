...
4. `BACKLOG-004-pwa-support.md` (V2)
- Progressive Web App support with offline capabilities
- Status: Planning

5. `BACKLOG-005-search-and-tags.md` (V2)
- Full-text search and tag management system
- Status: Planning

6. `BACKLOG-006-note-sharing.md` (V2)
- Read-only note sharing via shareable links
- Status: Planning
